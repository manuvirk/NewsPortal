     ...
     <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                       ...
                       <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" name="title_en" placeholder="Name">
                       </div>

                       <div class="form-group col-md-6">
                        <label for="exampleInputName1">Title Hindi</label>
                        <input type="text" class="form-control" id="exampleInputName1" name="title_hin" placeholder="Name">
                       </div>
                    </div>
                     ...
                     <div class="row">
                      ...
                      <div class="row">
                       ...
                       <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" name="tags_en" placeholder="Name">
                       </div>

                       <div class="form-group col-md-6">
                        <label for="exampleInputName1">Tags Hindi</label>
                        <input type="text" class="form-control" id="exampleInputName1" name="tags_hin" placeholder="Name">
                       </div>
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="summernote1" name="details_en" rows="4"></textarea>
                      </div>

                      <div class="form-group">
                        <label for="exampleTextarea1">Details Hindi</label>
                        <textarea class="form-control" id="summernote" name="details_hin" rows="4"></textarea>
                      </div>
                    <br>
                     <hr> 
                 <h4 class="text-center">Extra</h4> 
                      <div class="row">
                              ...
                              <label class="form-check-label col-md-3">
                                <input type="checkbox" class="form-check-input" name="bigthumbnail" value="1"> General Big Thumbnail <i class="input-helper"></i></label>
