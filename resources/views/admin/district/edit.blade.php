...
<div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{route('update.districts',$district->id)}}" >
                    @csrf
                      <div class="form-group">
                        <label for="exampleInputUsername1">District English</label>
                        <input type="text" class="form-control" id="district_en" name="district_en" value="{{ $district->district_en}}">
                        @error('district_en')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="district_hin" name="district_hin" value="{{$district->district_hin}}">
                           @error('district_hin')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                      </div>
