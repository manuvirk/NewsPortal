                  ...
                  <div class="card-body">
                    ...
                    @csrf
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="subdistrict_en" name="subdistrict_en" value="{{$subdistrict->subdistrict_en}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="subdistrict_hin" name="subdistrict_hin" value="{{$subdistrict->subdistrict_hin}}">
                      ...
                      <div class="form-group">
                      <label for="exampleFormControlSelect2">District Name</label>
                      <select class="form-control" id="district_name" name="district_name">
                      <option disabled="" selected="">--select District</option>
                      @foreach($district as $districts)
                        <option value="{{$districts->id}}">{{$districts->district_en}} | {{$districts->district_hin}}</option> 
                      @endforeach
                      </select>
                    </div>
