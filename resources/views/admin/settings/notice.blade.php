...
<div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{route('update.notices', $notices->id)}}">
                    @csrf
                      <div class="form-group">
                        <label for="exampleInputUsername1">notice</label>
                        <input type="text" class="form-control" id="notice" name="notice" value="{{$notices->notice}}">
                        @error('category_en')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="status" name="status" value= "{{$notices->status}}">
                           @error('category_hin')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                      </div>
