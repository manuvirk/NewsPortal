                  ...
                  <div class="card-body">
                    ...
                    @csrf
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="category_en" name="category_en" placeholder="Category English">
                        @error('category_en')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="category_hin" name="category_hin" placeholder="Category Hindi">
                           @error('category_hin')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                      </div>
