...
<div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{route('store.videos')}}" enctype="multipart/form-data">
                    @csrf
                      ...
                      <div class="form-group">
                        <label for="exampleInputUsername1"> Embedded Code </label>
                        <input type="text" class="form-control" id="embed_code" name="embed_code" placeholder="embed_code">
