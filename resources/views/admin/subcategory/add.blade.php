...
<div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{route('store.subcategories')}}">
                    @csrf
                      <div class="form-group">
                        <label for="exampleInputUsername1">SubCategory English</label>
                        <input type="text" class="form-control" id="subcategory_en" name="subcategory_en" placeholder="Category English">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="subcategory_hin" name="subcategory_hin" placeholder="Category Hindi">
