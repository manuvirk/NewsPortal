  @php
   $category = DB::table('categories')->orderBy('id','ASC')->get();
	  $links = DB::table('socials')->get()->first();
		$headlines = DB::table('posts')->where('posts.headline',1)->limit(2)->get();
							...
							<li>
								<div class="dropdown">
								  ...
								  <div class="dropdown-content">
									<a href="{{ $links->facebook }}" target="_blank"><i class="fa fa-facebook" aria-hidden="true"> Facebook</i> </a>
									<a href="{{ $links->twitter }}" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i> Twitter</a>
									<a href="{{ $links->youtube }}" target="_blank"><i class="fa fa-youtube-play" aria-hidden="true"></i> Youtube</a>
									<a href="{{ $links->instagram }}" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i> Instagram</a>
								  </div>
								</div>
							</li>
						</ul>
